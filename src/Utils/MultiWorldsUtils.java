...
public class MultiWorldsUtils {
	...
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.COMMAND_BLOCK_OUTPUT", as.getGameRuleValue("COMMAND_BLOCK_OUTPUT")); //22 rules
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DISABLE_ELYTRA_MOVEMENT_CHECK", as.getGameRuleValue("DISABLE_ELYTRA_MOVEMENT_CHECK"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DISABLE_RAIDS", as.getGameRuleValue("DISABLE_RAIDS"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_DAYLIGHT_CYCLE", as.getGameRuleValue("DO_DAYLIGHT_CYCLE"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_ENTITY_DROPS", as.getGameRuleValue("DO_ENTITY_DROPS"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_FIRE_TICK", as.getGameRuleValue("DO_FIRE_TICK"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_LIMITED_CRAFTING", as.getGameRuleValue("DO_LIMITED_CRAFTING"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_MOB_LOOT", as.getGameRuleValue("DO_MOB_LOOT"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_TILE_DROPS", as.getGameRuleValue("DO_TILE_DROPS"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.DO_WEATHER_CYCLE", as.getGameRuleValue("DO_WEATHER_CYCLE"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.KEEP_INVENTORY", as.getGameRuleValue("KEEP_INVENTORY"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.LOG_ADMIN_COMMANDS", as.getGameRuleValue("LOG_ADMIN_COMMANDS"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.MAX_COMMAND_CHAIN_LENGTH", as.getGameRuleValue("MAX_COMMAND_CHAIN_LENGTH"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.MAX_ENTITY_CRAMMING", as.getGameRuleValue("MAX_ENTITY_CRAMMING"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.MOB_GRIEFING", as.getGameRuleValue("MOB_GRIEFING"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.RANDOM_TICK_SPEED", as.getGameRuleValue("RANDOM_TICK_SPEED"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.REDUCED_DEBUG_INFO", as.getGameRuleValue("REDUCED_DEBUG_INFO"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.SEND_COMMAND_FEEDBACK", as.getGameRuleValue("SEND_COMMAND_FEEDBACK"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.SHOW_DEATH_MESSAGES", as.getGameRuleValue("SHOW_DEATH_MESSAGES"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.SPAWN_RADIUS", as.getGameRuleValue("SPAWN_RADIUS"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.SPECTATORS_GENERATE_CHUNKS", as.getGameRuleValue("SPECTATORS_GENERATE_CHUNKS"));
	Loader.mw.addDefault("WorldsSettings."+as.getName()+".Gamerule.ANNOUNCE_ADVANCEMENTS", as.getGameRuleValue("ANNOUNCE_ADVANCEMENTS"));

...
public class Configs {
	...
	public static void TranslationsLoading() {
		...
		c.put("PlayerList.Staff", Arrays.asList("&7=-=-=- %online% / %max_players% -=-=-=", "&8Online staff: &a%staff%",
				"&7=-=-=-=-=-=-=-=-="));
		c.put("PlayerList.Normal", Arrays.asList("&7=-=-=- %online% / %max_players% -=-=-=", "&8Staff: &a%staff%",
		...
		c.put("RAM.Info.Normal", Arrays.asList("&6-=-=-=-=-=-=-=-=-=-=-=-", "&aFree Memory: &6%free_ram% MB",
				"&aUsed Memory: &6%used_ram% MB", "&aMax Memory: &6%max_ram% MB", "&6-=-=-=-=-=-=-=-=-=-=-=-"));
		c.put("RAM.Info.Percent",
				Arrays.asList("&6-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-",
		...
		c.put("Homes.TeleportingOtherToOther",
		...
		c.put("TpaSystem.TpLocationPlayer",
		...
		c.put("OnJoin.FirstJoin.Messages",
				Arrays.asList("&6-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-",
		...
		c.put("Inventory.OpeningEnderChestForTarget",
		...
		c.put("Inventory.OpeningInvseeForTarget",
		...
		c.put("ClearChat.SpecifedChatHaveBypass",
		...
		c.put("AboutYou", Arrays.asList("&a-=-=-=-=-=-< &6%playername% &a>-=-=-=-=-=-", "&aNickname: &6%player%",
		...
		c.put("Security.TryingSendBlockedCommand",
		...
		c.put("ChatLock.ChatIsLockedErrorPlayerMessage",
		...
		c.put("BroadCastMessageVulgarWord",
		...
		c.put("BroadCastMessageAdvertisementPickupItem",
				"&ePlayer &6%player% &etried pickup item with an advertisement &8( &6%message% &8)&e.");
		c.put("BroadCastMessageAdvertisementDropItem",
		...
		c.put("VulgarWordsList-PlayerMessage",
	...
	public static void configLoading() {
		...
		c.put("Options.Maintenance.KickMessages",
		...
		c.put("Options.FarmingSystem", true);
		...
		c.put("Options.WarningSystem.Restart.Messages", Arrays.asList("&8****** &4Warning &8******",
		...
		c.put("Options.WarningSystem.Stop.Messages", Arrays.asList("&8****** &4Warning &8******",
		...
		c.put("Options.AutoMessage.Messages", Arrays.asList(
		...
		c.put("Options.ServerList.MOTD.Text.Normal",
				"&8-------< &eMinecraft Server &8>-------%line%&aServer is online");
		c.put("Options.ServerList.MOTD.Text.Maintenance",
		...
		c.put("Options.Join.FirstJoin.PerformCommands.List",
		...
		if (!Loader.config.existPath("BanSystem.Warn.Operations")) {
			...
			c.put("BanSystem.Warn.Operations.21.Commands",
		...
		c.put("TasksOnSend.Swear.Commands",
		...
		c.put("TasksOnSend.Advertisement.Commands", Arrays
		...
		c.put("AutoKickLimit.Spam.Commands.List",
		...
		c.put("AutoKickLimit.Kick.Commands.List",
	...
	public static void TabLoading() {
		...
		if (!Loader.tab.existPath("Groups.default")) {
			...
			c.put("PerPlayerTabList.timtower.Footer",
					Arrays.asList("&7--------------------------------", "&6Money: &a%money%$   &6Rank: &a%group%"));
			c.put("PerPlayerTabList.timtower.Header",
					Arrays.asList("&4Welcome back %playername% !", "&7--------------------------------"));
			c.put("PerWorldTabList.world1.Footer",

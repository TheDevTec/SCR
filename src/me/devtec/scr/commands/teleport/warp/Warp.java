...
public class Warp implements ScrCommand {
	public static Config storedWarps;
	...
	public void init(List<String> cmds) {
		...
		for (String key : storedWarps.getKeys("warp")) {
			++count;
			WarpManager.create(storedWarps.getAs("warp." + key + ".owner", UUID.class), key, storedWarps.getAs("warp." + key + ".location", Position.class),
					storedWarps.getAs("warp." + key + ".icon", Material.class), storedWarps.getString("warp." + key + ".permission"), storedWarps.getDouble("warp." + key + ".cost"));
		}
	...
	public void disabling() {
		for (WarpHolder warp : WarpManager.registered_warps)
			storedWarps.set("warp." + warp.name() + ".owner", warp.owner()).set("warp." + warp.name() + ".location", warp.location()).set("warp." + warp.name() + ".icon", warp.icon())
					.set("warp." + warp.name() + ".permission", warp.permission()).set("warp." + warp.name() + ".cost", warp.cost());
